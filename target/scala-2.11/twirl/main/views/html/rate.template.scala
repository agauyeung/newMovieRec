...
"""),_display_(/*4.2*/base(title, email)/*4.20*/ {_display_(Seq[Any](format.raw/*4.22*/("""	"""),format.raw/*4.70*/("""
    ...
    """),_display_(/*14.6*/form(action = routes.RecApplication.rate(), 'id -> "ratingsForm")/*14.71*/ {_display_(Seq[Any](format.raw/*14.73*/("""
        ...
        """)))}),format.raw/*22.10*/("""
        """),format.raw/*23.9*/("""<input type="submit" class="tenratings" value="Submit Ratings">         
    """)))}),format.raw/*24.6*/("""
    """),format.raw/*25.43*/("""
""")))}),format.raw/*26.2*/("""
"""))
...
object rate extends rate_Scope0.rate
              /*
                  -- GENERATED --
                  DATE: Sat Nov 28 01:09:50 PST 2015
                  SOURCE: /home/agauyeung/typesafe_activator_1.3.6/newMovieRec/app/views/rate.scala.html
                  HASH: baff01abb977c45f73ec28ac95f0ec760c427cee
                  MATRIX: 784->1|993->99|1020->117|1047->119|1073->137|1112->139|1140->187|1172->194|1197->211|1235->212|1270->221|1520->441|1558->524|1590->530|1664->595|1704->597|1741->607|1799->649|1839->651|1880->665|2214->978|2256->989|2292->998|2400->1076|2433->1119|2465->1121
